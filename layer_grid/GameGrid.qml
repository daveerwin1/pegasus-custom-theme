...
FocusScope {
    ...
    GridView {
        ...
        // Make the view keep the current item in view.
        highlightRangeMode: GridView.StrictlyEnforceRange
        preferredHighlightBegin: 0
        preferredHighlightEnd: height

        // Trigger repositions on all the usual layout churn points:
        //onCurrentIndexChanged: _scheduleReposition()
        onContentHeightChanged: grid.positionViewAtIndex(grid.currentIndex, GridView.Contain)
        onWidthChanged: grid.positionViewAtIndex(grid.currentIndex, GridView.Contain)
        //onCountChanged: _scheduleReposition()
        //onColumnCountChanged: _scheduleReposition()
        //onCellHeightRatioChanged: _scheduleReposition()
